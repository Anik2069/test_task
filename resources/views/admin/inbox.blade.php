...
<head>
    ...
    <div id="sidebar-menu" class="sidebar-menu">
      <ul>
        ...
        <li>
          <a href="category.html"><i class="fe fe-layout"></i> <span>Category</span></a>
        </li>
        <li>
          <a href="projectadd.html"><i class="fe fe-users"></i> <span>Add Project</span></a>
        </li>
        <li>
          <a href="preview.html"><i class="fe fe-user-plus"></i> <span>Project Preview</span></a>
        </li>
        <li class="active">
          <a href="inbox.html"><i class="fe fe-user"></i> <span>Inboxs</span></a>
        </li>
        ...
        <li>
          <a href="admin.html"><i class="fe fe-users"></i> <span>Add Admin</span></a>
        </li>
        <li>
          <a href="adminlist.html"><i class="fe fe-user"></i> <span>Admin List</span></a>
        </li>
        <li>
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Inboxs</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
									<li class="breadcrumb-item"><a href="javascript:(0);">Inboxs</a></li>
